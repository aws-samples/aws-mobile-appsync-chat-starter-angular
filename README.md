...
This is a Starter Angular progressive web application (PWA) that takes advantage of AWS AppSync offline and real-time capabilities to allow different users to communicate via chat. A script creates a GraphQL Schema, a related API, an Amazon Cognito User Pool for AuthN/Z as well as provisions Amazon DynamoDB resources, then connects them appropriately with Resolvers. The application demonstrates GraphQL Mutations, Queries and Subscriptions using AWS AppSync. You can use this for learning purposes or adapt either the application or the GraphQL Schema to meet your needs.
